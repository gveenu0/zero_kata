...
public class multi_player_hard extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (addFunc.btn_music) {
            startService(new Intent(multi_player_hard.this, ServFad.class));
        }
    ...
    private boolean checkForWin(){
        ...
        for (int i = 0; i<dimention;i++){
            if(field[i][0].equals(field[i][1]) &&
                ...
                buttons[i][3].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
                buttons[i][4].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
                return true;
            }
        }
        ...
        for (int i = 0; i<dimention;i++){
            if(field[0][i].equals(field[1][i]) &&
                ...
                buttons[3][i].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
                buttons[4][i].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
                return true;
            }
        }
        ...
        if(field[0][0].equals(field[1][1]) &&
            ...
            buttons[3][3].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            buttons[5][5].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            return true;
        }
        ...
        if(field[0][4].equals(field[1][3]) &&
                ...
                !field[0][4].equals("")){
            buttons[4][0].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            buttons[3][1].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            buttons[2][2].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            buttons[1][3].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            buttons[0][4].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            return true;
        }
    ...
    public void onPause(){
        super.onPause();
        stopService(new Intent(multi_player_hard.this,ServFad.class));
    }
}
