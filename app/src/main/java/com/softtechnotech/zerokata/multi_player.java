...
public class multi_player extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (addFunc.btn_music){
            startService(new Intent(multi_player.this,ServFad.class));
        }
    ...
    private boolean checkForWin(){
        ...
        if(field[0][3].equals(field[1][2]) &&
                ...
                !field[0][3].equals("")){
            buttons[3][0].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            buttons[2][1].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            buttons[1][2].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            buttons[0][3].setBackground(this.getResources().getDrawable(R.drawable.xowinbtn));
            return true;
        }
    ...
    public void onPause(){
        super.onPause();
        stopService(new Intent(multi_player.this,ServFad.class));
    }
}
